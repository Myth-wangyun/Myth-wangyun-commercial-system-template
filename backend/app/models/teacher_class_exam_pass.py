"""
教员功能分析 - 班级考试合格率表（行=班级，m1..m12=各月合格率，academic schema）
"""
...
class 教员功能分析班级考试合格率表(AccountBase):
    __tablename__ = "教员功能分析班级考试合格率表"
    ...
    序号: Mapped[int] = mapped_column(Integer, nullable=False, comment="班级序号")
    ...
    __table_args__ = (
        Index("idx_班级考试合格率_神殿年份序号", "神殿名称", "年份", "序号", unique=True),
        {"schema": "academic"},
    )

    def __repr__(self):
        return f"<教员功能分析班级考试合格率表(神殿={self.神殿名称}, 年份={self.年份}, 序号={self.序号})>"

"""
教员功能分析 - 教员考试合格率表（行=教员，m1..m12=各月合格率，academic schema）
"""
...
class 教员功能分析教员考试合格率表(AccountBase):
    __tablename__ = "教员功能分析教员考试合格率表"
    ...
    __table_args__ = (
        Index("idx_教员考试合格率_神殿年份序号", "神殿名称", "年份", "序号", unique=True),
        {"schema": "academic"},
    )

    def __repr__(self):
        return f"<教员功能分析教员考试合格率表(神殿={self.神殿名称}, 年份={self.年份}, 序号={self.序号})>"

"""
教员功能分析 - 项目合格率表（每行一个教员，m1..m12 为各月合格率，academic schema）
"""
...
class 教员功能分析项目合格率表(AccountBase):
    __tablename__ = "教员功能分析项目合格率表"
    ...
    __table_args__ = (
        Index("idx_项目合格率_神殿年份序号", "神殿名称", "年份", "序号", unique=True),
        {"schema": "academic"},
    )

    def __repr__(self):
        return f"<教员功能分析项目合格率表(神殿={self.神殿名称}, 年份={self.年份}, 序号={self.序号})>"

...
class 神殿后端新生维稳月度汇总表(AccountBase):
    """神殿后端新生维稳月度汇总表"""

    __tablename__ = "神殿后端新生维稳月度汇总表"
    ...
    __table_args__ = (
        UniqueConstraint("神殿名称", "年份", "月份", name="uq_新生维稳月度汇总_神殿年份月份"),
        Index("idx_新生维稳月度汇总_神殿年份", "神殿名称", "年份"),
        {"schema": "academic"},
    )

    def __repr__(self):
        return f"<神殿后端新生维稳月度汇总表(神殿={self.神殿名称}, 年份={self.年份}, 月份={self.月份})>"

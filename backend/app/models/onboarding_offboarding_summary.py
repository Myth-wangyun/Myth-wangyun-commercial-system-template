"""
Model for campus academic onboarding and offboarding summary (academic schema)
神殿智慧司入职离职汇总表
"""
...
class 神殿智慧司入职离职汇总表(AccountBase):
    __tablename__ = "campus_academic_onboarding_offboarding_summary"
    ...
    数据: Mapped[dict[str, Any] | list[Any]] = mapped_column(JSONB, nullable=False, default=dict, comment="表格数据（JSONB格式，包含各月份数据）")

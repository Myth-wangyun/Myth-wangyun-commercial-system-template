"""
教学质量模块 - 家长访谈记录表 API
路由：/api/v1/teaching-quality/parent-interview-record
"""
...
from app.teaching_quality.TQparent_interview_record_db import (
    fetch_interview_rows,
    init_parent_interview_tables,
...
@router.get("/parent-interview-record", response_model=InterviewList, summary="获取家长访谈记录表")
...
@router.post("/parent-interview-record", response_model=InterviewList, summary="保存家长访谈记录表（按维度覆盖写入）")

"""
教学质量模块 - 毕业生家长访谈记录表 API
路由：/api/v1/teaching-quality/graduate-parent-interview-record
"""
...
from app.teaching_quality.TQgraduate_parent_interview_record_db import (
...
@router.get("/graduate-parent-interview-record", response_model=InterviewList, summary="获取毕业生家长访谈记录表")
...
@router.post("/graduate-parent-interview-record", response_model=InterviewList, summary="保存毕业生家长访谈记录表（按维度覆盖写入）")

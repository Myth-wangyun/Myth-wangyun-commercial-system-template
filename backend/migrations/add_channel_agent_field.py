"""
数据库迁移脚本：添加缺失字段到咨询量明细表_v2

执行方式：
cd backend
python migrations/add_channel_agent_field.py
"""
...
def run_migration():
    ...
    fields_to_add = [
        ('渠道代理', 'VARCHAR(50)', '渠道代理'),
        ('网聊专员', 'VARCHAR(50)', '网聊专员'),
        ('咨询次数', 'INTEGER DEFAULT 1', '咨询次数'),
    ]

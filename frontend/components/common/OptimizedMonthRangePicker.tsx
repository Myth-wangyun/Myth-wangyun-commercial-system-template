...
interface OptimizedMonthRangePickerProps {
...
const OptimizedMonthRangePicker: React.FC<OptimizedMonthRangePickerProps> = memo(
  ({
    value,
    defaultValue,
...
OptimizedMonthRangePicker.displayName = 'OptimizedMonthRangePicker'

export default OptimizedMonthRangePicker

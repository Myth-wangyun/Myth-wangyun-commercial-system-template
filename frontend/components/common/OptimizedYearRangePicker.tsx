...
interface OptimizedYearRangePickerProps {
...
const OptimizedYearRangePicker: React.FC<OptimizedYearRangePickerProps> = memo(
  ({
    value,
    defaultValue,
...
OptimizedYearRangePicker.displayName = 'OptimizedYearRangePicker'

export default OptimizedYearRangePicker

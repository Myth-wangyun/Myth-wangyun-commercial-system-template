/**
 * 神殿教化司核心数据 - 升学计划表
 * Sheet：汇总（计划/个人/月度等）+ 班级明细（下拉切换班级）
 */
...
import PromotionSummarySheet from './SummarySheet'
import PromotionClassDetailSheet from './ClassDetailSheet'

type TabKey = 'summary' | 'detail'

const CoreData2PromotionPlanPage: React.FC = () => {
  ...
  const tabs = [
    ...
    { key: 'detail' as TabKey, label: '班级明细' },
  ]
  ...
  return (
    ...
    >
      ...
      {activeTab === 'summary' && <PromotionSummarySheet />}
      {activeTab === 'detail' && <PromotionClassDetailSheet />}
    </div>
  )
}

export default CoreData2PromotionPlanPage

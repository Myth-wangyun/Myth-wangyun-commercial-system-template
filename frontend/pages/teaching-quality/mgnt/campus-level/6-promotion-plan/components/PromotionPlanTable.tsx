...
import type { PromotionPlanTableProps, PromotionPlanRecord } from '@/types/promotion-plan'

const PromotionPlanTable: React.FC<PromotionPlanTableProps> = ({
  data,
  loading,
  onRefresh,
  onEdit,
  ...
  const columns: ColumnsType<PromotionPlanRecord> = [
    {
      title: '月份',
      dataIndex: 'month',
      key: 'month',
    ...
    },
    {
      ...
      width: 120,
      fixed: 'right',
      render: (_: any, record: PromotionPlanRecord) => {
        if (record.rowType === 'total') {
          return null
        }
        return (

...
import type {
  ...
  CampusEnrollmentStatisticsEditModalProps,
} from '@/types/campus-enrollment-statistics'

const CampusEnrollmentStatisticsEditModal: React.FC<CampusEnrollmentStatisticsEditModalProps> = ({
  visible,
  record,
  onCancel,
  onOk,
      ...
      <Form form={form} layout="vertical">
        <Form.Item
          ...
          rules={[
            ...
            { type: 'number', min: 1, max: 12, message: '月份必须在1-12之间' },
          ]}
        >
          <InputNumber style={{ width: '100%' }} placeholder="请输入月份（1-12）" />
        </Form.Item>
...
export default CampusEnrollmentStatisticsEditModal

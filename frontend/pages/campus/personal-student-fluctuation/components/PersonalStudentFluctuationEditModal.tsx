...
import type { PersonalStudentFluctuationEditModalProps } from '@/types/personal-student-fluctuation'

const PersonalStudentFluctuationEditModal: React.FC<PersonalStudentFluctuationEditModalProps> = ({
  open,
  record,
  onCancel,
  onOk,
  ...
  return (
    <Modal
      title={record ? '编辑个人统计学员异动' : '新增个人统计学员异动'}
      open={open}
      onOk={handleSubmit}
    ...
    >
      <Form form={form} layout="vertical">
        ...
        <Row gutter={16}>
          ...
          <Col span={12}>
            <Form.Item label="异动总人数(累计)" name="totalFluctuationCount">
              <InputNumber style={{ width: '100%' }} min={0} placeholder="自动计算" disabled />
            </Form.Item>
          </Col>
        </Row>
...
export default PersonalStudentFluctuationEditModal

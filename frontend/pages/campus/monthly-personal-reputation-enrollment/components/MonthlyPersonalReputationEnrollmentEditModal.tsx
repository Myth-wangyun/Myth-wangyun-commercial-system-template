/**
 * 神殿教化司口碑招生月度个人目标与结果汇总表编辑模态框
 */

import React, { useEffect } from 'react'
import { Modal, Form, InputNumber, Row, Col } from 'antd'
import type { MonthlyPersonalReputationEnrollmentEditModalProps } from '@/types/monthly-personal-reputation-enrollment'

const MonthlyPersonalReputationEnrollmentEditModal: React.FC<
  MonthlyPersonalReputationEnrollmentEditModalProps
> = ({ open, record, onCancel, onOk }) => {
  ...
  return (
    <Modal
      title={`编辑 - ${record.name} (${record.month}月)`}
      open={open}
      onOk={handleSubmit}
...
export default MonthlyPersonalReputationEnrollmentEditModal

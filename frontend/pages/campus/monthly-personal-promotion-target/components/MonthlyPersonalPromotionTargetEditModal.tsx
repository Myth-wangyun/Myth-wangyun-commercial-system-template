/**
 * 神殿教化司月度个人升学目标与结果汇总表编辑模态框
 */

import React, { useEffect } from 'react'
import { Modal, Form, InputNumber, Input, Row, Col, Select } from 'antd'
import type { MonthlyPersonalPromotionTargetEditModalProps } from '@/types/monthly-personal-promotion-target'

const MonthlyPersonalPromotionTargetEditModal: React.FC<
  MonthlyPersonalPromotionTargetEditModalProps
> = ({ open, record, onCancel, onOk }) => {
  ...
  return (
    <Modal
      title={record ? '编辑月度个人升学目标与结果' : '新增月度个人升学目标与结果'}
      open={open}
      onOk={handleSubmit}
        ...
        <Row gutter={16}>
          ...
          <Col span={12}>
            <Form.Item label="姓名" name="name" rules={[{ required: true }]}>
              <Select options={personOptions} placeholder="请选择姓名" />
            </Form.Item>
          </Col>
        </Row>
...
export default MonthlyPersonalPromotionTargetEditModal

...
import type {
  PersonalPromotionTargetTableProps,
  PersonalPromotionTargetRecord,
} from '@/types/personal-promotion-target'

const PersonalPromotionTargetTable: React.FC<PersonalPromotionTargetTableProps> = ({
  data,
  loading,
  onRefresh,
  onEdit,
  ...
  const columns: ColumnsType<PersonalPromotionTargetRecord> = [
    {
      title: '序号',
    ...
    },
    {
      ...
      width: 120,
      fixed: 'right',
      render: (_: any, record: PersonalPromotionTargetRecord) => {
        if (record.rowType === 'total') {
          return null
        }
        return (
...
export default PersonalPromotionTargetTable

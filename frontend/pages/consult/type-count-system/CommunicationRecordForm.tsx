...
export default function CommunicationRecordForm({
  visible,
  onClose,
  onSuccess,
  记录ID,
  ...
  return (
    ...
    >
      <Form
        ...
        style={{ marginTop: -12 }}
      >
        <Divider orientation="left" style={{ margin: '8px 0', fontSize: '13px', color: '#666' }}>基本信息</Divider>
        <Row gutter={12}>
          <Col span={7}>
            <Form.Item
              name="沟通时间"
          ...
          <Col span={4}>
            <Form.Item name="用时" label="用时(分)" style={{ marginBottom: 8 }}>
              <InputNumber min={0} max={999} style={{ width: '100%' }} />
            </Form.Item>
          </Col>
          <Col span={5}>
            <Form.Item name="咨询师" label="咨询师" style={{ marginBottom: 8 }}>
              <Input placeholder="姓名" />
            </Form.Item>
          </Col>
          <Col span={3}>
            <Form.Item name="联系不上" label="失联" valuePropName="checked" style={{ marginBottom: 8 }}>
              <Switch size="small" />
            </Form.Item>
          </Col>
        </Row>

        <Divider orientation="left" style={{ margin: '8px 0', fontSize: '13px', color: '#666' }}>沟通分析</Divider>
        <Row gutter={12}>
          <Col span={8}>
            <Form.Item name="需求点" label="需求点" style={{ marginBottom: 8 }}>
              <Input placeholder="客户的需求点" />
            </Form.Item>
          </Col>
          <Col span={8}>
            <Form.Item name="关注点" label="关注点" style={{ marginBottom: 8 }}>
              <Input placeholder="客户关注什么" />
            </Form.Item>
          </Col>
          <Col span={8}>
            <Form.Item name="抗拒点" label="抗拒点" style={{ marginBottom: 8 }}>
              <Input placeholder="客户的顾虑" />
            </Form.Item>
          </Col>
        </Row>

        <Divider orientation="left" style={{ margin: '8px 0', fontSize: '13px', color: '#666' }}>意愿评估</Divider>
        <Row gutter={12}>
          <Col span={5}>
            <Form.Item name="报名意愿" label="意愿等级" style={{ marginBottom: 8 }}>
          ...
          <Col span={6}>
            <Form.Item name="课程意向" label="课程意向" style={{ marginBottom: 8 }}>
              <Input placeholder="意向课程" />
            </Form.Item>
          </Col>
          <Col span={6}>
            <Form.Item name="具备条件" label="具备条件" style={{ marginBottom: 8 }}>
              <Input placeholder="条件描述" />
            </Form.Item>
          </Col>
          <Col span={7}>
            <Form.Item name="预定回访时间" label="预定回访" style={{ marginBottom: 8 }}>
        ...
        <Divider orientation="left" style={{ margin: '8px 0', fontSize: '13px', color: '#666' }}>沟通详情</Divider>
        <Form.Item name="咨询内容" label="咨询内容" style={{ marginBottom: 8 }}>
          <TextArea rows={3} placeholder="详细记录沟通内容..." />
        </Form.Item>

        <Form.Item name="咨询结果" label="咨询结果" style={{ marginBottom: 0 }}>
          <TextArea rows={2} placeholder="沟通结果..." />
        </Form.Item>
      </Form>
    </Modal>
  )

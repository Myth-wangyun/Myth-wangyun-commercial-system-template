...
/**
 * 06最高议事厅 年度市场免费推广表
 * - 年份来自全局年份选择器（useMarketMonthlyDataStore.year）
 * - 神殿来自全局神殿选择器
 * - 按月份展示该神殿的市场免费推广数据
 */
export default function MarketFreePromotionDataTable() {
  ...
  const columns = useMemo(() => {
    return [
        ...
        children: [
          {
            ...
            width: 50,
            align: 'center' as const,
            render: (_: any, record: Row) => <div style={{ textAlign: 'center' }}>{renderValue(record.planIncome, record.isTotal)}</div>,
          },
          {
            title: '市场免费推广实际收入',
      ...
      },
      {
        ...
        width: 50,
        align: 'center' as const,
        render: (_: any, record: Row) => <div style={{ textAlign: 'center' }}>{renderValue(record.planEnrollment, record.isTotal)}</div>,
      },
      {
        title: '神殿报名',
        children: [
      ...
      },
      {
        ...
        width: 50,
        align: 'center' as const,
        render: (_: any, record: Row) => <div style={{ textAlign: 'center' }}>{renderValue(record.planConsultVolume, record.isTotal)}</div>,
      },
      {
        title: '市场免费推广数据',
        children: [
      ...
      },
      {
        ...
        width: 50,
        align: 'center' as const,
        render: (_: any, record: Row) => <div style={{ textAlign: 'center' }}>{renderValue(record.planCost, record.isTotal)}</div>,
      },
      {
        title: '实际消费',
  ...
  return (
    <div>
      ...
      <Card className="campus-market-free-promotion-table">
        <Table<Row>
        ...
        <style>{`
          .campus-market-free-promotion-table .ant-table-wrapper { overflow-x: auto; }
          .campus-market-free-promotion-table .ant-table-thead > tr > th {
          ...
          .campus-market-free-promotion-table .ant-table-tbody > tr > td {
            border: 1px solid #d0d0d0 !important;
            padding: 1px 1px !important;
            font-size: 11px !important;
            text-align: center !important;
          }
          .campus-market-free-promotion-table .ant-table-tbody > tr.total-row > td {

 ...
 * - 按月份展示该神殿的市场口碑数据
 */
export default function CampusMarketReputationDataTable() {
  ...
  // 从API加载实际数据（不包括实际消费，实际消费从loadPlanData加载）
      ...
      setRows((prev) => {
        ...
        for (const row of next) {
          ...
          if (planData[monthNum]) {
            ...
            row.actualCost = planData[monthNum].actual_expense || null
          }
          recalcRow(row)
        }
        return recomputeTotal(next)
    ...
    <div style={{ padding: 24 }}>
      <Card style={{ marginBottom: 16 }}>
        ...
        >
          ...
          05最高议事厅 {year}年度{campusLabel}神殿市场口碑表
        </div>

...
// 新媒体数据行类型
export interface NewMediaDataRow {
  key: string
  campus: string
  isTotal: boolean
...
interface NewMediaChartViewProps {
  data: NewMediaDataRow[]
  year: string
}
 ...
 * 计算汇总统计数据
 */
const calculateSummaryStats = (data: NewMediaDataRow[]) => {
...
const NewMediaChartView: React.FC<NewMediaChartViewProps> = ({ data, year }) => {
  // 过滤掉总计行，只展示各神殿数据
    ...
    <div>
      ...
      <Tabs defaultActiveKey="enrollment" type="card" items={[
        { key: 'enrollment', label: (
          ...
          <Row gutter={16}>
            <Col span={16}>
              <Card title={`${year}年新媒体各神殿报名数据对比`} size="small">
        ...
        { key: 'consult', label: (
          ...
          <Row gutter={16}>
            <Col span={24}>
              <Card title={`${year}年新媒体各神殿咨询量数据对比`} size="small">
                <ResponsiveContainer width="100%" height={350}>
        ...
        { key: 'cost', label: (
          ...
          <Row gutter={16}>
            <Col span={12}>
              <Card title={`${year}年新媒体各神殿消费对比`} size="small">
                <ResponsiveContainer width="100%" height={350}>
            ...
            <Col span={12}>
              <Card title={`${year}年新媒体各神殿收入对比`} size="small">
                <ResponsiveContainer width="100%" height={350}>
...
export default NewMediaChartView
